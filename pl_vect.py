...
plt.xlabel('Term size x-direction (Eq. R.1)')
plt.ylabel('y/H')
...
plt.xlabel('Term size y-direction (Eq. R.1)')
plt.ylabel('y/H')
plt.title('1.2 (x = 0.10) vertical line', fontsize=20)
plt.axis([-0.1, 0.1, 0, 1])
plt.legend()
...
plt.ylabel('y/H')
plt.title('1.2 y-direction (x = 1.07) vertical line', fontsize=20)
plt.axis([-0.1, 0.1, 0, 1])
plt.legend()
plt.tight_layout()
...
plt.xlabel('Term size (Eq. R.1)')
plt.ylabel('y/H')
plt.title('1.2 x-direction (x = 1.07) vertical line', fontsize=20)
